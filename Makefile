...
MILL_EXAMPLE     := example["$(SCALA_VERSION)"]
...
# Phony
# -----------------------------
.PHONY: help bsp idea ide-setup example-html js-compile js-fast js-full \
...
help:
	...
	@echo ""
	@echo "Example app (dev demo):"
	@echo "  example-html    - Run JVM side to generate HTML (writes example/web/src/html/index.html)."
	@echo "  js-compile      - Compile Scala.js sources."
	@echo "  js-fast         - FastLinkJS (dev mode JS)."
	@echo "  js-full         - FullLinkJS (optimized prod JS)."
	...
	@echo "Usage examples:"
	@echo "  make bsp"
	@echo "  make example-html"
	@echo "  make js-fast link-fast web-install web-dev"
	@echo "  make SCALA_VERSION=3.7.3 js-full link-full"
	@echo ""
...
show-config:
	...
	@echo "WATCH          = $(WATCH)"
	@echo "MILL_EXAMPLE   = $(MILL_EXAMPLE)"
...
example-html:
	$(MILL) $(WATCH) $(MILL_EXAMPLE).jvm.run

# Just compile the Scala.js (no linking)
js-compile:
	$(MILL) $(WATCH) $(MILL_EXAMPLE).js.compile

# Dev JS bundle
js-fast:
	$(MILL) $(WATCH) $(MILL_EXAMPLE).js.fastLinkJS

# Optimized prod JS bundle
js-full:
	$(MILL) $(WATCH) $(MILL_EXAMPLE).js.fullLinkJS
