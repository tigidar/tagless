package tags.defs.complex

import tags.codecs.{IterableAsSpaceSeparatedStringCodec, StringAsIsCodec}
import tags.keys.{HtmlAttr, Prop}
...
trait ComplexHtmlKeys {
  ...
  /**
    ...
    */
  val className: Prop[Iterable[String], String] = new Prop("class", IterableAsSpaceSeparatedStringCodec)
