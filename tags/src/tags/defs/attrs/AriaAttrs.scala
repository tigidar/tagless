...
trait AriaAttrs {
  ...
  def ariaAttr[V](name: String, codec: Codec[V, String]): AriaAttr[V] =
    new AriaAttr(name, codec)

  @inline protected def boolAsTrueFalseAriaAttr(
      name: String
  ): AriaAttr[Boolean] = ariaAttr(name, BooleanAsTrueFalseStringCodec)

  @inline protected def doubleAriaAttr(name: String): AriaAttr[Double] =
    ariaAttr(name, DoubleAsStringCodec)

  @inline protected def intAriaAttr(name: String): AriaAttr[Int] =
    ariaAttr(name, IntAsStringCodec)

  @inline protected def stringAriaAttr(name: String): AriaAttr[String] =
    ariaAttr(name, StringAsIsCodec)
  ...
  /** Identifies the currently active descendant of a composite widget.
    ...
    */
  lazy val activeDescendant: AriaAttr[String] = stringAriaAttr(
    "aria-activedescendant"
  )

  /** Indicates whether assistive technologies will present all, or only parts
    * of, the changed region based on the change notifications defined by the
    * aria-relevant attribute. See related [[relevant]].
    *
    * [[https://developer.mozilla.org/pr/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-atomic aria-atomic @ MDN]]
    */
  ...
  /** Indicates the current "checked" state of checkboxes, radio buttons, and
    * other widgets. See related [[pressed]] and [[selected]].
    *
  ...
  /** Identifies the element (or elements) whose contents or presence are
    * controlled by the current element. See related [[owns]].
    *
  ...
  /** Indicates the element that represents the current item within a container
    ...
    *
    * Enumerated: "page" | "step" | "location" | "date" | "time" | "true" |
    * "false" (default)
    *
  ...
  /** Indicates that the element is perceivable but disabled, so it is not
    * editable or otherwise operable. See related [[hidden]] and [[readOnly]].
    *
    * [[https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-disabled aria-disabled @ MDN]]
    */
  lazy val disabled: AriaAttr[Boolean] = boolAsTrueFalseAriaAttr(
    "aria-disabled"
  )
  ...
  /** Indicates what functions can be performed when the dragged object is
    ...
    *
    * Enumerated: "copy" | "move" | "link" | "execute" | "popup" | "none"
    * (default)
    *
  ...
  /** Indicates whether the element, or another grouping element it controls, is
    ...
    */
  lazy val expanded: AriaAttr[Boolean] = boolAsTrueFalseAriaAttr(
    "aria-expanded"
  )
  ...
  /** Indicates that the element has a popup context menu or sub-level menu.
    ...
    */
  lazy val hasPopup: AriaAttr[Boolean] = boolAsTrueFalseAriaAttr(
    "aria-haspopup"
  )
  ...
  /** Identifies the element (or elements) that labels the current element. See
    * related [[label]] and [[describedBy]].
    *
  ...
  /** Indicates whether a text box accepts multiple lines of input or only a
    ...
    */
  lazy val multiLine: AriaAttr[Boolean] = boolAsTrueFalseAriaAttr(
    "aria-multiline"
  )
  ...
  /** Indicates that the user may select more than one item from the current
    ...
    */
  lazy val multiSelectable: AriaAttr[Boolean] = boolAsTrueFalseAriaAttr(
  ...
  /** Identifies an element (or elements) in order to define a visual,
    ...
    * where the DOM hierarchy cannot be used to represent the relationship. See
    * related [[controls]].
    *
  ...
  /** Indicates that the element is not editable, but is otherwise operable. See
    * related [[disabled]].
    *
    * [[https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-readonly aria-readonly @ MDN]]
    */
  lazy val readOnly: AriaAttr[Boolean] = boolAsTrueFalseAriaAttr(
    "aria-readonly"
  )
  ...
  /** Indicates what user agent change notifications (additions, removals, etc.)
    ...
    * [[atomic]].
    *
    * Enumerated: "additions" | "removals" | "text" | "all" | "additions text"
    * (default)
    *
  ...
  /** Indicates that user input is required on the element before a form may be
    ...
    */
  lazy val required: AriaAttr[Boolean] = boolAsTrueFalseAriaAttr(
    "aria-required"
  )
  ...
  /** Indicates the current "selected" state of various widgets. See related
    ...
    */
  lazy val selected: AriaAttr[Boolean] = boolAsTrueFalseAriaAttr(
    "aria-selected"
  )

  /** Defines the number of items in the current set of listitems or treeitems.
    * Not required if all elements in the set are present in the DOM. See
    * related [[posInSet]].
    *
